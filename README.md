...
\* Stores pipeline metadata (`etl\_control`)

\* Tracks execution logs (`etl\_audit\_log`)

\* Maintains incremental state (`etl\_watermarks`)
...
\* Stored in `etl\_watermarks` table
